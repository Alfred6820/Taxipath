...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    bullets: ["Early morning & late night availability", "Hatchback or MPV depending on luggage", "Confirm flight time when booking"],
  },
  {
    id: "sabarimala",
    ...
    description:
      "For pilgrims travelling from Kochi to Sabarimala — drivers who are used to the hill route, the checkpoints, and the early-start timing that Sabarimala trips need. Available in both hatchback and MPV depending on your group size, with drop at the Pamba base camp.",
    bullets: ["Drivers experienced on the Sabarimala route", "Early-morning departures", "Group-friendly MPV options available"],
  },
];
